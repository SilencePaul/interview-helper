...
四、服务器处理请求
服务器收到请求后流程如下：
Nginx / Apache 等 Web 服务器接收请求
请求转发到应用服务器（如 Java、Python、PHP 等）
应用服务器执行业务逻辑（访问数据库、缓存等）
构造 HTTP 响应并返回
五、返回 HTTP 响应
